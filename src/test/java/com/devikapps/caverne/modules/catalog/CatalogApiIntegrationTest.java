...
class CatalogApiIntegrationTest {
    ...
    void shouldListProductsWithPaginationAndFilters() throws Exception {
        ...
        productRepository.saveAll(List.of(
                ...
                product("Smoked Pepper", "PEP-002", false, "Inactive product", category, "MGA", "kg", 13500),
    ...
    void shouldReturnProductDetail() throws Exception {
        ...
        Product product = productRepository.save(product("Forest Honey", "HON-001", true, "Raw honey", category, "MGA", "jar", 18000));

        mockMvc.perform(get("/products/{id}", product.getId()).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
