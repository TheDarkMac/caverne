...
public class PriceInput {
  ...
  public PriceInput unit(@javax.annotation.Nullable String unit) {
    this.unit = unit;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currencyCode, priceInput.currencyCode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(currencyCode, value, validFrom, unit);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("currency_code", "value", "valid_from", "unit"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("currency_code", "value", "valid_from"));
  }
