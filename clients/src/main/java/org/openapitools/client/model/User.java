...
public class User {
  ...
  public User status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, firstname, lastname, email, phone, role, status);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "firstname", "lastname", "email", "phone", "role", "status"));
