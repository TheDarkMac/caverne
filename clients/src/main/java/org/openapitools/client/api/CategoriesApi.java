...
public class CategoriesApi {
     ...
     * @param flat Si true, retourne une liste plate sans enfants (optional)
     ...
     */
    public okhttp3.Call categoriesGetCall(@javax.annotation.Nullable Boolean flat, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call categoriesGetValidateBeforeCall(@javax.annotation.Nullable Boolean flat, final ApiCallback _callback) throws ApiException {
        return categoriesGetCall(flat, _callback);
     ...
     */
    public List<Category> categoriesGet(@javax.annotation.Nullable Boolean flat) throws ApiException {
        ApiResponse<List<Category>> localVarResp = categoriesGetWithHttpInfo(flat);
     ...
     */
    public ApiResponse<List<Category>> categoriesGetWithHttpInfo(@javax.annotation.Nullable Boolean flat) throws ApiException {
        okhttp3.Call localVarCall = categoriesGetValidateBeforeCall(flat, null);
        Type localVarReturnType = new TypeToken<List<Category>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Liste des catégories (arbre) (asynchronously)
     * 
     * @param flat Si true, retourne une liste plate sans enfants (optional)
     ...
     */
    public okhttp3.Call categoriesGetAsync(@javax.annotation.Nullable Boolean flat, final ApiCallback<List<Category>> _callback) throws ApiException {

        okhttp3.Call localVarCall = categoriesGetValidateBeforeCall(flat, _callback);
        Type localVarReturnType = new TypeToken<List<Category>>(){}.getType();
    ...
    /**
     * Supprimer une catégorie (admin) (asynchronously)
     * 
     * @param id  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Détail d&#39;une catégorie (asynchronously)
     * 
     * @param id  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call categoriesIdPutCall(@javax.annotation.Nonnull Integer id, @javax.annotation.Nonnull CategoryInput categoryInput, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = categoryInput;
    ...
    private okhttp3.Call categoriesIdPutValidateBeforeCall(@javax.annotation.Nonnull Integer id, @javax.annotation.Nonnull CategoryInput categoryInput, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'categoryInput' is set
        if (categoryInput == null) {
            throw new ApiException("Missing the required parameter 'categoryInput' when calling categoriesIdPut(Async)");
        }

        return categoriesIdPutCall(id, categoryInput, _callback);
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call categoriesPostValidateBeforeCall(@javax.annotation.Nonnull CategoryInput categoryInput, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'categoryInput' is set
        if (categoryInput == null) {
            throw new ApiException("Missing the required parameter 'categoryInput' when calling categoriesPost(Async)");
        }

        return categoriesPostCall(categoryInput, _callback);
    ...
    public Category categoriesPost(@javax.annotation.Nonnull CategoryInput categoryInput) throws ApiException {
        ApiResponse<Category> localVarResp = categoriesPostWithHttpInfo(categoryInput);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Category> categoriesPostWithHttpInfo(@javax.annotation.Nonnull CategoryInput categoryInput) throws ApiException {
        okhttp3.Call localVarCall = categoriesPostValidateBeforeCall(categoryInput, null);
        Type localVarReturnType = new TypeToken<Category>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call categoriesPostAsync(@javax.annotation.Nonnull CategoryInput categoryInput, final ApiCallback<Category> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = categoriesPostValidateBeforeCall(categoryInput, _callback);
        Type localVarReturnType = new TypeToken<Category>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
